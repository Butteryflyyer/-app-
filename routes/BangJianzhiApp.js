...
//注册接口
router.post('/registBangApp', function(req, res, next) {
  var dic = req.body;
...
//获取注册人列表
router.post('/getRegistBangList', function(req, res, next) {
...
//登录接口
router.post('/loginBangJianzhiApp', function(req, res, next) {
...
router.post('/postBangOrderChange', function(req, res, next) {
  var dic = req.body;
...
//拿去评价
router.post('/getBangPingjia', function(req, res, next) {
  var dic = req.body;
...
//评价
router.post('/BangPingjia', function(req, res, next) {
  var dic = req.body;
...
//反馈
router.post('/BangFankui', function(req, res, next) {
  var dic = req.body;
...
//拿取二维码
router.post('/getBangAppSQRR', function(req, res, next) {
  var dic = req.body;
