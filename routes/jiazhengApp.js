...
//注册接口
router.post('/registJiazhengApp', function(req, res, next) {
  var dic = req.body;
...
//获取注册人列表
router.post('/getjiazhengRegistPerson', function(req, res, next) {
...
//获取订单大厅
router.post('/getjiazhengList', function(req, res, next) {
  var dic = req.body;
